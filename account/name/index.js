...
function saveSettings() {
  document.getElementById("appearance_name").disabled = true;

  ssldata = new FormData()
  ssldata.append("realname", document.getElementById("appearance_name").value)
  ...
  $.ajax({
      ...
      success: function (data) {
          statusText = data;
          if (statusText == "ok") {
            document.getElementById("appearance_name").disabled = false;
            location.reload()
            return;
          }
