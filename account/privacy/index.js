...
function saveSettings() {
  document.getElementById("privacy_private").disabled = true;
  document.getElementById("privacy_discovery").disabled = true;

  ssldata = new FormData()
  if (document.getElementById("privacy_private").checked == true) { ssldata.append("private", "true") } else { ssldata.append("private", "false") }
  if (document.getElementById("privacy_discovery").checked == true) { ssldata.append("discovery", "true") } else { ssldata.append("discovery", "false") }
  ...
  $.ajax({
      ...
      success: function (data) {
          statusText = data;
          if (statusText == "ok") {
            document.getElementById("privacy_private").disabled = false;
            document.getElementById("privacy_discovery").disabled = false;
            location.reload()
            return;
          }
