...
function saveSettings() {
  document.getElementById("appearance_dark").disabled = true;

  if (document.getElementById("appearance_dark").checked) {
    loadjscssfile("/resources/style/dark.css", "css")
  } else {
    removejscssfile("/resources/style/dark.css", "css")
  }

  ssldata = new FormData()
  if (document.getElementById("appearance_dark").checked == true) { ssldata.append("dark", "true") } else { ssldata.append("dark", "false") }
  ...
  $.ajax({
      ...
      success: function (data) {
          statusText = data;
          if (statusText == "ok") {
            document.getElementById("appearance_dark").disabled = false;
            return;
          }
