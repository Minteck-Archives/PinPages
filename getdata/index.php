...
if ($_GET['type'] == "json") {
    ...
    header("Content-Disposition: attachment; filename=\"PinPagesUserDatabase_{$user}_" . date('YmdHis') . ".json\"");
...
if ($_GET['type'] == "ini") {
    ...
    echo("[PinpagesUserDatabase]\n");
    echo("username=" . $data['username'] . "\n");
    echo("\n[Settings]\n");
    echo("realname=" . $data['settings']['realname'] . "\n");
    echo("darkmode=" . $data['settings']['darkmode'] . "\n");
    echo("email=" . $data['settings']['email'] . "\n");
    exit;
}

echo("Unexpected Type: " . $_GET['type']);
exit;