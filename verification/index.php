    ...
    <body class="abody">
        ...
        <div class="header_escape">
            <div id="ep_editdiv">
                ...
                ?>
                <h1 class="ep_title"><?= $lang_verifmgr_title ?></h1>
                <?php

                if (file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/" . $suser . "/verification/status") == "True")
                {
                    echo("<span>" . $lang_verifmgr_status . " <b>" . $lang_verifmgr_enabled . "</b>" . $lang_verifmgr_since . "<b>" . file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/" . $suser . "/verification/since") .  "</b></span><br><br><a onclick=\"showConfirm()\" id=\"ep_act\" class=\"jslink\">" . $lang_verifmgr_remove . "</a><br>
                    <span class=\"tip\">" . $lang_verifmgr_tremove . "</span>");
                }
                else
                {
                    echo("<span>" . $lang_verifmgr_status . " <b>" . $lang_verifmgr_disabled . "</b></span><br><br><a onclick=\"showConfirm()\" id=\"ep_act\" class=\"jslink\">" . $lang_verifmgr_add . "</a><br>
                    <span class=\"tip\">" . $lang_verifmgr_tadd . "</span>");
                }
            ...
            <div id="ep_deldiv" class="hide">
                ...
                if (file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/" . $suser . "/verification/status") == "True")
                {
                    echo("<h1>" . $lang_verifmgr_ctitle . "</h1>" . $lang_verifmgr_ydesc . "<br><br><a onclick=\"toggleVerification()\" id=\"dact2\" class=\"jslink\">" . $lang_verifmgr_yact . "</a><br><a onclick=\"cancel()\" class=\"jslink\">" . $lang_verifmgr_cancel . "</a>");
                }
                else
                {
                    echo("<h1>" . $lang_verifmgr_ctitle . "</h1>" . $lang_verifmgr_ndesc . "<br><br><a onclick=\"toggleVerification()\" id=\"dact2\" class=\"jslink\">" . $lang_verifmgr_nact . "</a><br><a onclick=\"cancel()\" class=\"jslink\">" . $lang_verifmgr_cancel . "</a>");
                }
