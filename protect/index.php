...
<html>
    <head>
        ...
        <title><?= $lang_protect_titlep1 . $suser . $lang_verifmgr_titlep2 ?></title>
        <meta charset="UTF-8">
    ...
    <body class="abody">
        ...
        <div class="header_escape">
            <div id="ep_editdiv">
                ...
                {
                    echo("<h1>" . $lang_protect_atitle . "</h1>" . $lang_protect_adesc);
                    exit;
                }

                ?>
                <h1 class="ep_title"><?= $lang_protect_title ?></h1>
                <?= $lang_protect_desc ?><br><span style="color:red;font-weight:bold"><?= $lang_protect_disclaimer ?></span><br><br>
                <a onclick="next()" id="dact1" class="jslink"><?= $lang_protect_continue ?></a><br>
            </div>
            <div id="ep_deldiv" class="hide">
                <h1><?= $lang_protect_ctitle ?></h1>
                <?= $lang_protect_cdesc ?><br><span style="color:red;font-weight:bold"><?= $lang_protect_disclaimer ?></span><br><br>
