...
if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/private/bugs-reports/" . $user)) {
    $reports = scandir($_SERVER['DOCUMENT_ROOT'] . "/private/bugs-reports/" . $user);
    sort($reports, SORT_NUMERIC);
    $reports = array_reverse($reports);
    $id = (int)$reports[0] + 1;
} else {
    mkdir($_SERVER['DOCUMENT_ROOT'] . "/private/bugs-reports/" . $user);
    $id = 0;
}
mkdir($_SERVER['DOCUMENT_ROOT'] . "/private/bugs-reports/" . $user . "/" . $id);
