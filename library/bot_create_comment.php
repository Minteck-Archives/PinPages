...
if (file_exists($botroot . "/data/" . $user . "/" . $post . "/comments_count")) {
    $count = trim(file_get_contents($botroot . "/data/" . $user . "/" . $post . "/comments_count")) + 1;
} else {
    $count = 1;
}

file_put_contents($botroot . "/data/" . $user . "/" . $post . "/comments_new", $puser . "#" . $newtext . "#" . $count . "\n" . file_get_contents($botroot . "/data/" . $user . "/" . $post . "/comments_new"));
file_put_contents($botroot . "/data/" . $user . "/" . $post . "/comments_count",$count);
